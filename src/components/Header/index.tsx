						...
						{userState.isAuth ? (
							...
							<>
								<li>
									<Link
										to='/login'
										className='inline-flex items-center justify-center h-12 tracking-wide  transition duration-200 shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline	focus:outline-none text-black bg-yellow-500 hover:bg-yellow-700 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900'
										aria-label='LogIn'
										title='LogIn'
									>
										LogIn
